...
class JsonDataUtil:
    class L2AR:
        ...
        def convert_json_to_object(self, file_path: str, is_clear=True) -> Report:
            ...
            # return Report(report_theme, global_overview, modular_test_results_display, optimization_suggestions)
        ...
        def convert_json_to_object2(self, file_path: str, is_clear=True) -> Report:
            ...
            return Report(
                ...
                Modular_Test_Results_Display=modular_test_results_display,
                # Optimization_Suggestions_or_Solutions=optimization_suggestions
            )
        ...
        def update_status_indicators3(self, report, test_name, test_state, is_clear=True):
            ...
            try:
                ...
                field_patterns = {
                    ...
                    'MTK_COMMON': REGEX_PATTERNS_For_Status_Indicators['mtk_common']
                }
